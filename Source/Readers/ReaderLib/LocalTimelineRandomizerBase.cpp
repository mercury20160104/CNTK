...
std::map<std::wstring, size_t> LocalTimelineRandomizerBase::GetState()
{
    ...
    state[L"base_sweepIndex"] = m_sweepIndex;
    state[L"base_currentSequencePositionInWindow"] = m_window.m_sequencePosition;
    state[L"base_numberOfSamplesSeenSoFar"] = m_numberOfSamplesSeenSoFar;
...
{
    m_sweepIndex = ValueFrom(state, L"base_sweepIndex");
    m_numberOfSamplesSeenSoFar = ValueFrom(state, L"base_numberOfSamplesSeenSoFar");
    m_window.m_sequencePosition = ValueFrom(state, L"base_currentSequencePositionInWindow");
